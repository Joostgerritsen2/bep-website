...
function getFaqJsonLd(lang: string) {
  if (lang === 'en') {
    return {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'What does BEP cost?', acceptedAnswer: { '@type': 'Answer', text: 'BEP is available from €595/month for the Start plan, including onboarding and live in 2 to 4 weeks. Check our pricing page for all plans and options.' } },
  ...
  return {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Wat kost BEP?', acceptedAnswer: { '@type': 'Answer', text: 'BEP is beschikbaar vanaf €595/maand voor het Start-pakket, inclusief onboarding en live in 2 tot 4 weken. Bekijk onze pricing-pagina voor alle pakketten en mogelijkheden.' } },
