...
export const pageMeta: Record<string, Record<Locale, { title: string; description: string }>> = {
  ...
  team: {
    nl: { title: 'Team: De mensen achter BEP', description: 'Maak kennis met het team achter BEP — AI-specialisten, engineers en business consultants.' },
    en: { title: 'Team: The people behind BEP', description: 'Meet the team behind BEP — AI specialists, engineers and business consultants.' },
  },
  pricing: {
    nl: { title: 'Pricing: BEP Bedrijfsexpert', description: 'Kies het BEP-pakket dat bij jouw organisatie past. Van Start tot Platform, altijd 100% in je eigen cloud.' },
    en: { title: 'Pricing: BEP Business Expert', description: 'Choose the BEP plan that fits your organization. From Start to Platform, always 100% in your own cloud.' },
  },
  contact: {
